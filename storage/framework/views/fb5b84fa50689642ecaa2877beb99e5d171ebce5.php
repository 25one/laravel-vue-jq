    ...
    <header class="header">
        ...
        <div class="header_content d-flex flex-row align-items-center justify-content-start">
            ...
            <div class="header_right d-flex flex-row align-items-center justify-content-start ml-auto">
                ...
                <!-- Cart -->
                <div class="cart"><a href="<?php echo e(url('/cart')); ?>"><div class="wrapper"><img class="svg" src="<?php echo e(asset('images/cart.svg')); ?>" alt="https://www.flaticon.com/authors/freepik"><span><layout-component ref="refCartCount"></layout-component></span></div></a></div> <!-- class="wrapper" span -->
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="<?php echo e(route('dashboard-users')); ?>"> <!-- !!! пока для всех -->
                            <b>Dashboard</b>
                        </a>
                        <?php endif; ?> 
...
</html><?php /**PATH /var/www/resources/views/product/layout.blade.php ENDPATH**/ ?>