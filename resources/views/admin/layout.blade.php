...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('AdminLTE/css/bootstrap-4.1.2/bootstrap.min.css') }}">
...
<script src="{{ asset('AdminLTE/css/bootstrap-4.1.2/popper.js') }}"></script>
<script src="{{ asset('AdminLTE/css/bootstrap-4.1.2/bootstrap.min.js') }}"></script>
